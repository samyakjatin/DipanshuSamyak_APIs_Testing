...
public class auction_controller_21 {
    ...
    public void loginToSystem() {
      ...
      //  request.queryParam("lotDiamondInfo", "");  // Add lotDiamondInfo parameter
        ...
        String token = "eyJhbGciOiJIUzI1NiJ9.eyJhY3RpdmUiOnRydWUsInJvbGVzIjpbIkJpZGRlciJdLCJmaXJzdE5hbWUiOiJ3YWdoIiwidXNlcklkIjoiMzQ1MDA2MDItNzI2ZC00ZWI0LTkxYjYtNmFmMjFkOWU4ZGEyIiwibGFzdE5hbWUiOiJEb2UiLCJzdWIiOiJwcmFzaGFudCIsImlhdCI6MTczNTI5OTMyOSwiZXhwIjoxNzM1MzI5MzI5fQ.Qe8U0GJDt_kjppP_EBFqzMaqjZAzb5Ihp3QYsG6Divk";  
     ...
     //  request.pathParam("userId", userId);
       // request.pathParam("auctionId", auctionId);
        ...
        Response response = request.get("/auction/active/count"); 
