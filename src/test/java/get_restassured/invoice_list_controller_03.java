...
public class invoice_list_controller_03 {
    ...
    public void loginToSystem() {
       ...
       // request.queryParam("lotDiamondInfo", "");  // Add lotDiamondInfo parameter
        ...
        String token = "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOiIxMDVjODQ0Yi01Y2VmLTQ0YjItYWUzMS05NDFiZmI5NDczNzYiLCJsYXN0TmFtZSI6IkRvZSIsImFjdGl2ZSI6dHJ1ZSwicm9sZXMiOlsiQmlkZGVyIl0sImZpcnN0TmFtZSI6IndhZ2giLCJzdWIiOiJwcmFzaGFudCIsImlhdCI6MTczMjk1MjA5NywiZXhwIjoxNzMyOTU4MDk3fQ.a6VmEu5ZMwJes67nzdnAku3Qolu2RhAsaxLVMm11Y_M";  
        ...
        Response response = request.get("/hold-invoice/list/{auctionId}"); 
