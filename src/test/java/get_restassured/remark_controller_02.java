...
public class remark_controller_02 {
    ...
    public void loginToSystem() {
        ...
        String token = "eyJhbGciOiJIUzI1NiJ9.eyJhY3RpdmUiOnRydWUsImxhc3ROYW1lIjoiRG9lIiwidXNlcklkIjoiMTA1Yzg0NGItNWNlZi00NGIyLWFlMzEtOTQxYmZiOTQ3Mzc2IiwiZmlyc3ROYW1lIjoid2FnaCIsInJvbGVzIjpbIkJpZGRlciJdLCJzdWIiOiJwcmFzaGFudCIsImlhdCI6MTczMjg2NDI4NiwiZXhwIjoxNzMyODcwMjg2fQ.WQkwS-YhLDEo3SbkGn1WsmEKQe8UhGR_EqkU2q12LSk";  
       ...
       String lotDiamondInfo ="";
        
        // Add path parameters dynamically
     request.pathParam("userId", userId);
      request.pathParam("auctionId", auctionId);
      request.pathParam("lotDiamondInfo", lotDiamondInfo);
        
        // Send the GET request with query parameters
        Response response = request.get("/remark/{userId}/{auctionId}"); 
