...
public class ImageUploadController {
    ...
    public void createSymmetry() {
        ...
        File files = new File("C:/WorkSpaces/Swastik2425_Workspace/Postsample/Testing/polish_Masters_Excel.xlsx");
       ...
       // request.multiPart("userId", "7828500F-5781-40D5-9E61-ADF2A09EB993");
        request.multiPart("lotNumber", "DQ        009");
        // Send the POST request
        Response response = request.post("/swastik/upload");
