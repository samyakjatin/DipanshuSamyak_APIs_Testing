...
public class shape_controller_04 {
    ...
    public void loginToSystem() {
      ...
      //  request.queryParam("lotDiamondInfo", "");  // Add lotDiamondInfo parameter
        ...
        String token = "eyJhbGciOiJIUzI1NiJ9.eyJhY3RpdmUiOnRydWUsImxhc3ROYW1lIjoiRG9lIiwidXNlcklkIjoiMTA1Yzg0NGItNWNlZi00NGIyLWFlMzEtOTQxYmZiOTQ3Mzc2IiwiZmlyc3ROYW1lIjoid2FnaCIsInJvbGVzIjpbIkJpZGRlciJdLCJzdWIiOiJwcmFzaGFudCIsImlhdCI6MTczMjg1NjIzMCwiZXhwIjoxNzMyODYyMjMwfQ.NC1wzPJbvVn978jgRRWH1ogbyo7dPMGPLZfaOvvRHPE";  
     ...
     //  request.pathParam("userId", userId);
       // request.pathParam("auctionId", auctionId);
        ...
        Response response = request.get("/shapes"); 
