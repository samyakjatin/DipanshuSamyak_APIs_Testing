...
public class bid_controller_15 {
    ...
    public void loginToSystem() {
        ...
        String token = "eyJhbGciOiJIUzI1NiJ9.eyJmaXJzdE5hbWUiOiJ3YWdoIiwidXNlcklkIjoiMTA1Yzg0NGItNWNlZi00NGIyLWFlMzEtOTQxYmZiOTQ3Mzc2IiwibGFzdE5hbWUiOiJEb2UiLCJhY3RpdmUiOnRydWUsInJvbGVzIjpbIkJpZGRlciJdLCJzdWIiOiJwcmFzaGFudCIsImlhdCI6MTczMjY5MzA3MSwiZXhwIjoxNzMyNjk5MDcxfQ.0rrMDRux2pAXgAdLiAD-3_L7JLNenaosm058CI140FY";  
       ...
       request.pathParam("userId", userId);
        ...
        Response response = request.get("/bid/getMyBidCount/{userId}/{auctionId}		"); 
