...
public class lot_diamond_image_controller_02 {
    ...
    public void loginToSystem() {
       ...
       // request.queryParam("lotDiamondInfo", "");  // Add lotDiamondInfo parameter
        ...
        String token = "eyJhbGciOiJIUzI1NiJ9.eyJhY3RpdmUiOnRydWUsImxhc3ROYW1lIjoiRG9lIiwidXNlcklkIjoiMTA1Yzg0NGItNWNlZi00NGIyLWFlMzEtOTQxYmZiOTQ3Mzc2IiwiZmlyc3ROYW1lIjoid2FnaCIsInJvbGVzIjpbIkJpZGRlciJdLCJzdWIiOiJwcmFzaGFudCIsImlhdCI6MTczMjg3NjM4MCwiZXhwIjoxNzMyODgyMzgwfQ.wZ0Bc40XUFWoI01ayKTSP9779EWVQbjWyzv25xKgd4w";  
       ...
       // request.pathParam("auctionId", auctionId);
        ...
        Response response = request.get("/lot-diamond-images"); 
